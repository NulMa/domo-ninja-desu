...
namespace DomoNinja.Unity
{
    ...
    public sealed class ResultController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _titleLabel = board.Find("TitleLabel").GetComponent<Text>();
            _statsLabel = board.Find("StatsLabel").GetComponent<Text>();
            _rewardLabel = board.Find("RewardLabel").GetComponent<Text>();
